...
/**
 * Hyprland implementation of DockPlatform.
 *
 * Uses the wlr-layer-shell protocol (via LayerShellQt) for positioning,
 * but avoids KWin-specific extensions like KWindowEffects.
 */
class HyprlandDockPlatform : public DockPlatform
{
public:
    HyprlandDockPlatform();
